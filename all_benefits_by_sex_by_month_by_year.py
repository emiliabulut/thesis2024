...
# MAGIC %md
# MAGIC ## All benefits by sex by month by year
# MAGIC This notebook creates a table with the following columns: total_benefits, sex, month and year.
...
# MAGIC %md
# MAGIC Load the data from the table that was created as part of the data_cleanup notebook
...
# MAGIC %md
# MAGIC Only include the total compensation rows
...
# MAGIC %md
# MAGIC Group the data by year and sex
...
# Error: Undefined name `DoubleType`
# Fix: Add the necessary import statement for `DoubleType` from `pyspark.sql.types`
